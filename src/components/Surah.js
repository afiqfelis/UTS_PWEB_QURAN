    ...
    return (
        <>
            ...
            <Container className="title-container">
                <h1 className="title-content">Qur'an Web</h1>
                        ...
                        <Col key={surat.number} className="surah-wrapper">
                            <Card className="surah-card">
                                ...
                                <h4 className="surah-title">
                                    ...
                                    <Button className="btn-read-surah shadow-none" variant="light"><Link to={`/surah/${surat.number}`}>Mulai Membaca</Link></Button>
                                </Card.Body>
                            </Card>
                        </Col>
                    )
